...
### Адрес приложения
Приложение развернуто и доступно по адресу: `http://188.40.110.12`

---

## Проверка статуса сервисов

Если вам необходимо проверить работу приложения или веб-сервера на удаленном сервере, используйте следующие команды:

1. **Проверка статуса самого приложения:**
   ```bash
   sudo systemctl status my_app
   ```

2. **Проверка статуса веб-сервера Nginx:**
   ```bash
